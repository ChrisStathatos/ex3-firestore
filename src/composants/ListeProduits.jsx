...
export default function ListeProduits(props) {
  ...
  useEffect(() => {
    async function getProduits() {
      ...
      reponse.forEach(
         doc => tabProduits.push({id:doc.id,nom:doc.nom,prix:doc.prix, ...doc.data()})
       )
  ...
  return (
    <div className="ListeProduits">
      ...
      <ul>        
        ...
        */
          produits.map(
             produit => <Produit key={produit.id} etatPanier={props.etatPanier} id={props.id}nom={props.nom} prix={props.prix}/>
